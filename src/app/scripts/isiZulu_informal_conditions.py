...
def main():
    ...
    audio1 = audio_player_service.loadFile(HOME_AUDIO_PATH + audio_files["1"])
    audio2 = audio_player_service.loadFile(HOME_AUDIO_PATH + audio_files["2"])
    audio3 = audio_player_service.loadFile(HOME_AUDIO_PATH + audio_files["3"])
    audio4 = audio_player_service.loadFile(HOME_AUDIO_PATH + audio_files["4"])
    audio5 = audio_player_service.loadFile(HOME_AUDIO_PATH + audio_files["5"])
